...
def run_module():
    ...
    module_args = dict(
        ...
        min_replication=dict(type='int', required=False, default=''),
        replication=dict(type='int', required=False, default=''),
        soft_quota=dict(type='str', required=False, default=''),
        hard_quota=dict(type='str', required=False, default='')
    )
